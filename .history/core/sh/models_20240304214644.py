...
class Province(models.Model):
  number_id = models.CharField(max_length = 2, verbose_name = 'Numero de Identificación')
...
class ImgPrinterDevice(models.Model):
  ...
  def __str__(self):
    return f'{self.model.brand.brand} - {self.model.model} - {self.ip}'
...
class Computer(models.Model):
  ...
  def __str__(self):
    return f'{self.model.brand.brand} - {self.model.model} - {self.ip} - {self.pc_net_name} - {self.employee.employee_last_name}, {self.employee.employee_name}'
